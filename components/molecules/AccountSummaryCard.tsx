    ...
    <Card className="flex flex-col gap-4">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-zinc-500 dark:text-zinc-400">IBAN {iban}</p>
        </div>
        <Badge tone={statusTone}>{statusLabel}</Badge>
      </div>
      <div className="flex items-end justify-between gap-3">
        <div>
          <p className="text-sm text-zinc-500 dark:text-zinc-400">Solde</p>
          <p className="text-2xl font-semibold text-zinc-900 dark:text-zinc-100">{balance}</p>
        </div>
