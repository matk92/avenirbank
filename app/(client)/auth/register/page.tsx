...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-emerald-50/60 px-4 py-16">
      <div className="w-full max-w-xl space-y-6">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-semibold text-emerald-900">{t('auth.registerTitle')}</h1>
          <LanguageSwitcher />
        </div>
        <Card>
          <form onSubmit={submit} className="grid gap-4 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              <Button type="submit">{t('auth.register.cta')}</Button>
            </div>
          </form>
